        ...
        class RegisterUser extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... voids) {
                ...
                String s = rh.sendPostRequest
                        ("https://shantini123.000webhostapp.com/insert_registration.php",hashMap);
                return s;
            }
        ...
        private void makeRequest(final String encoded_string, final String image_name) {
            class UploadAll extends AsyncTask<Void, Void, String> {
                ...
                protected String doInBackground(Void... params) {
                    ...
                    String s = rh.sendPostRequest("https://shantini123.000webhostapp.com/insert_registration.php", hashMap);
                    return s;
                }
